...
# funcion que lee un conjunto de datos y la posici�n de un atributo
# y los ordena por un atributo especifico
def ordenar(archivo, atributo):
    """
    lee un conjunto de datos y la posici�n de un atributo
...
def genproxcorte(archivo, desplazamiento, atributo):
    """
    va a buscar la proxima posici�n a cortar
    :param archivo: un conjunto de datos
...
# Funci�n que va a recibir el conjunto de datos, y la posici�n del atributo
